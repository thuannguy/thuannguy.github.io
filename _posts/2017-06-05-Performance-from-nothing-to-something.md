...
Don't get me wrong. I knew that sometimes perceptions are more important than numbers/metrics and that there is something called [perceptual speed index](https://developers.google.com/web/tools/lighthouse/audits/speed-index). However, I believe that it is even a higher level of performance because it requires that both metrics and perceptions must be good and thus I consider it out of the scope of this post. 
